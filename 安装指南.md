...
| **Translate**: | [English](https://github.com/openvinotoolkit/openvino_notebooks) |  
| -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
...
运行OpenVINO Notebooks需要预装Python和Git， 针对不同操作系统的安装参考以下指南：
...
将pip升级到最新版本，使用 --use-deprecated=legacy-resolver 避免依赖冲突。

```bash
python -m pip install --upgrade pip
pip install -r requirements.txt --use-deprecated=legacy-resolver -i https://pypi.tuna.tsinghua.edu.cn/simple
